...
BOSS_RESPAWNS = {
    "Rotura": 12.35,    # 12 horas e 35 minutos
    "Stomid": 18,
    "Tigdal": 12.25,
    "Hakir": 18.35,
        ...
        try:
            ...
            for boss in BOSS_RESPAWNS:
                        ...
                        for channel_id in CHANNEL_IDS:
                            ...
                            if channel:
                                if time_left == 0:
                                    ...
                                    # Reinicia o timer para o próximo spawn após 10 minutos
                ...
                if time_left > 0:
                    ...
                    # Se o boss acabou de spawnar, reinicia o tempo após 10 minutos
                    if time_left == 0:
                        await asyncio.sleep(600)  # Aguarda 10 minutos antes de resetar
                        self.boss_timers[boss] = BOSS_RESPAWNS[boss] * 60  # Reseta o timer para o tempo padrão
        except Exception as e:
